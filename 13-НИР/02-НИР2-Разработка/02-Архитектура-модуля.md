...
![Рисунок 1 — Схема взаимодействия компонентов системы](99-images/fig01-architecture.png)

![Рисунок 2 — Развёртывание контейнеров на хосте](99-images/fig02-deployment.png)

![Рисунок 3 — Поток данных от сенсора до исполнительных механизмов](99-images/fig03-data-flow.png)
