...
![Рисунок 1 — Схема взаимодействия компонентов системы](../images/fig01-architecture.png)

![Рисунок 2 — Развёртывание контейнеров на хосте](../images/fig02-deployment.png)

![Рисунок 3 — Поток данных от сенсора до исполнительных механизмов](../images/fig03-data-flow.png)
