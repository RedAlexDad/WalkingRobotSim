...
bool cdr_serialize_ros2_unitree_legged_msgs__msg__LED(
  const ros2_unitree_legged_msgs__msg__LED * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ros2_unitree_legged_msgs__msg__LED(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs__msg__LED * ros_message);
...
bool cdr_serialize_key_ros2_unitree_legged_msgs__msg__LED(
  const ros2_unitree_legged_msgs__msg__LED * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ros2_unitree_legged_msgs__msg__LED(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ros2_unitree_legged_msgs__msg__LED(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ros2_unitree_legged_msgs__msg__HighCmd(
  const ros2_unitree_legged_msgs__msg__HighCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: head
  {
  ...
  // Field name: led
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros2_unitree_legged_msgs__msg__LED(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
bool cdr_deserialize_ros2_unitree_legged_msgs__msg__HighCmd(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs__msg__HighCmd * ros_message)
{
  // Field name: head
  {
    size_t size = 2;
  ...
  // Field name: led
  {
    ...
    auto array_ptr = ros_message->led;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros2_unitree_legged_msgs__msg__LED(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
bool cdr_serialize_key_ros2_unitree_legged_msgs__msg__HighCmd(
  const ros2_unitree_legged_msgs__msg__HighCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: head
  ...
  // Field name: led
  {
    ...
    auto array_ptr = ros_message->led;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros2_unitree_legged_msgs__msg__LED(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
size_t get_serialized_size_key_ros2_unitree_legged_msgs__msg__HighCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HighCmd__ros_msg_type * ros_message = static_cast<const _HighCmd__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: led
  {
    ...
    auto array_ptr = ros_message->led;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros2_unitree_legged_msgs__msg__LED(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
size_t max_serialized_size_key_ros2_unitree_legged_msgs__msg__HighCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: led
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros2_unitree_legged_msgs__msg__LED(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2_unitree_legged_msgs__msg__HighCmd * ros_message = static_cast<const ros2_unitree_legged_msgs__msg__HighCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2_unitree_legged_msgs__msg__HighCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2_unitree_legged_msgs__msg__HighCmd * ros_message = static_cast<ros2_unitree_legged_msgs__msg__HighCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2_unitree_legged_msgs__msg__HighCmd(cdr, ros_message);
}
