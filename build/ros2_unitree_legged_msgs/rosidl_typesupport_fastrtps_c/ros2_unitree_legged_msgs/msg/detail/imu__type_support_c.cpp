  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2_unitree_legged_msgs__msg__IMU * ros_message = static_cast<const ros2_unitree_legged_msgs__msg__IMU *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2_unitree_legged_msgs__msg__IMU(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2_unitree_legged_msgs__msg__IMU * ros_message = static_cast<ros2_unitree_legged_msgs__msg__IMU *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2_unitree_legged_msgs__msg__IMU(cdr, ros_message);
}
