...
bool cdr_serialize_ros2_unitree_legged_msgs__msg__BmsCmd(
  const ros2_unitree_legged_msgs__msg__BmsCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ros2_unitree_legged_msgs__msg__BmsCmd(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs__msg__BmsCmd * ros_message);
...
bool cdr_serialize_key_ros2_unitree_legged_msgs__msg__BmsCmd(
  const ros2_unitree_legged_msgs__msg__BmsCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ros2_unitree_legged_msgs__msg__BmsCmd(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ros2_unitree_legged_msgs__msg__BmsCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ros2_unitree_legged_msgs__msg__MotorCmd(
  const ros2_unitree_legged_msgs__msg__MotorCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_ros2_unitree_legged_msgs__msg__MotorCmd(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs__msg__MotorCmd * ros_message);
...
bool cdr_serialize_key_ros2_unitree_legged_msgs__msg__MotorCmd(
  const ros2_unitree_legged_msgs__msg__MotorCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_ros2_unitree_legged_msgs__msg__MotorCmd(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_ros2_unitree_legged_msgs__msg__MotorCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
...
bool cdr_serialize_ros2_unitree_legged_msgs__msg__LowCmd(
  const ros2_unitree_legged_msgs__msg__LowCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: head
  {
  ...
  // Field name: motor_cmd
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ros2_unitree_legged_msgs__msg__MotorCmd(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: bms
  {
    cdr_serialize_ros2_unitree_legged_msgs__msg__BmsCmd(
      &ros_message->bms, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
bool cdr_deserialize_ros2_unitree_legged_msgs__msg__LowCmd(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs__msg__LowCmd * ros_message)
{
  // Field name: head
  {
    size_t size = 2;
  ...
  // Field name: motor_cmd
  {
    ...
    auto array_ptr = ros_message->motor_cmd;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ros2_unitree_legged_msgs__msg__MotorCmd(cdr, &array_ptr[i]);
    }
  }

  // Field name: bms
  {
    cdr_deserialize_ros2_unitree_legged_msgs__msg__BmsCmd(cdr, &ros_message->bms);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
bool cdr_serialize_key_ros2_unitree_legged_msgs__msg__LowCmd(
  const ros2_unitree_legged_msgs__msg__LowCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: head
  ...
  // Field name: motor_cmd
  {
    ...
    auto array_ptr = ros_message->motor_cmd;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ros2_unitree_legged_msgs__msg__MotorCmd(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: bms
  {
    cdr_serialize_key_ros2_unitree_legged_msgs__msg__BmsCmd(
      &ros_message->bms, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
size_t get_serialized_size_key_ros2_unitree_legged_msgs__msg__LowCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowCmd__ros_msg_type * ros_message = static_cast<const _LowCmd__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: motor_cmd
  {
    ...
    auto array_ptr = ros_message->motor_cmd;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ros2_unitree_legged_msgs__msg__MotorCmd(
        &array_ptr[index], current_alignment);
    }
  }

  // Field name: bms
  current_alignment += get_serialized_size_key_ros2_unitree_legged_msgs__msg__BmsCmd(
    &(ros_message->bms), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
size_t max_serialized_size_key_ros2_unitree_legged_msgs__msg__LowCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros2_unitree_legged_msgs__msg__MotorCmd(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: bms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ros2_unitree_legged_msgs__msg__BmsCmd(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2_unitree_legged_msgs__msg__LowCmd * ros_message = static_cast<const ros2_unitree_legged_msgs__msg__LowCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2_unitree_legged_msgs__msg__LowCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2_unitree_legged_msgs__msg__LowCmd * ros_message = static_cast<ros2_unitree_legged_msgs__msg__LowCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2_unitree_legged_msgs__msg__LowCmd(cdr, ros_message);
}
