...
bool cdr_serialize_ros2_unitree_legged_msgs__msg__LowState(
  const ros2_unitree_legged_msgs__msg__LowState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: head
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
bool cdr_deserialize_ros2_unitree_legged_msgs__msg__LowState(
  eprosima::fastcdr::Cdr & cdr,
  ros2_unitree_legged_msgs__msg__LowState * ros_message)
{
  // Field name: head
  {
    size_t size = 2;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
bool cdr_serialize_key_ros2_unitree_legged_msgs__msg__LowState(
  const ros2_unitree_legged_msgs__msg__LowState * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: head
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
size_t get_serialized_size_key_ros2_unitree_legged_msgs__msg__LowState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowState__ros_msg_type * ros_message = static_cast<const _LowState__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_unitree_legged_msgs
size_t max_serialized_size_key_ros2_unitree_legged_msgs__msg__LowState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ros2_unitree_legged_msgs__msg__LowState * ros_message = static_cast<const ros2_unitree_legged_msgs__msg__LowState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ros2_unitree_legged_msgs__msg__LowState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ros2_unitree_legged_msgs__msg__LowState * ros_message = static_cast<ros2_unitree_legged_msgs__msg__LowState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ros2_unitree_legged_msgs__msg__LowState(cdr, ros_message);
}
