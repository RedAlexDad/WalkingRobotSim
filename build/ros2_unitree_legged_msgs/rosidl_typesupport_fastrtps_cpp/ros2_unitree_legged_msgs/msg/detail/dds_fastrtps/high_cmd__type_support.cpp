...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_unitree_legged_msgs
max_serialized_size_key_HighCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: bms
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_BmsCmd(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: led
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_unitree_legged_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_LED(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
