...
$$
\mathrm{traversability} = 1 - w_{\mathrm{slope}} \cdot \mathrm{slopeCost} - w_{\mathrm{roughness}} \cdot \mathrm{roughnessCost} - w_{\mathrm{elevation}} \cdot \mathrm{elevationDiffCost}
$$
