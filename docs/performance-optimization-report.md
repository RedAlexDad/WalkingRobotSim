...
|---------|:-----------:|:--------:|:---------:|
| `rotxyz` | 0.0019 | 0.0001 | **34.0x** |
| `homog_transform_inverse` | 0.0084 | 0.0003 | **28.9x** |
| `FK` | 0.0985 | 0.0019 | **51.4x** |
| `IK` | 0.0030 | 0.0007 | **4.1x** |
| `local_positions` | 0.0448 | 0.0003 | **147.7x** |
| `GaitController.phase_ticks` | 0.0001 | 0.0000 | **7.9x** |
| `update_odometry` | 0.0022 | 0.0002 | **11.3x** |
| **ИТОГО** | **0.1587** | **0.0035** | **45.3x** |
