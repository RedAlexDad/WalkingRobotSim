...
class Postprocessing {
  public:
     ...
     */
    void postprocess(PlanarTerrain& planarTerrain, const std::string& elevationLayer,
  ...
  private:
    ...
    void addSmoothLayer(grid_map::GridMap& gridMap, const Eigen::MatrixXf& elevationData,
