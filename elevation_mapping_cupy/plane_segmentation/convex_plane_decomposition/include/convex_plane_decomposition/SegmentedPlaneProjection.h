...
/**
 * Projects a point in the plane to the closest point on the contour of a planar region. We take the inset (slight
 * inward offset from the boundary) as the contour to project to.
 ...
 *  where p is the query point, and p_projected is the Euclidean projection to the candidate region, both in world
 * frame.
 *
 *  The bounding box of each region is used to find a lower bound on this cost, it is therefore important the user
 * defined penalty is non-negative.
 *
 * @param positionInWorld : Query point in world frame
 * @param planarRegions : Candidate planar regions
