...
struct SegmentedPlanesMap {
    ...
    /// Image with a each pixel being assigned and integer value corresponding to the label. Might contain labels that
    /// are not in labelPlaneParameters. These labels should be seen as background.
    cv::Mat labeledImage;
