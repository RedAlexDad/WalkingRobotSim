...
struct RansacPlaneExtractorParameters {
    ...
    /// Set maximum Euclidean distance between points to be clustered. Two points are connected if separated by a
    /// distance of at most 2*sqrt(2)*cluster_epsilon = 2.828 * cluster_epsilon
