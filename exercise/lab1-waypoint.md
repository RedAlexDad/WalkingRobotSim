...
4. **Метрики и анализ**:
   - Сравнение двух маршрутов (длина, количество точек, сложность)
   - Визуальное сравнение траекторий в RViz
5. **Выводы**:
   - Какие маршруты были созданы и чем отличаются
   - Какие сложности возникли при навигации
   - Рекомендации для использования в ЛР3

### Шаг 12. Остановка

```bash
# Остановить симуляцию — Ctrl+C в терминале с make gazebo-cpp
```
...
9. Что такое namespace в ROS 2? Почему топики имеют префикс `/robot1/`?
10. Как замерить время выполнения команды в Linux?
