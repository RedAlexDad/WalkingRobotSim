...
| №   | Работа                                         | Ориентировочное время |
| --- | ---------------------------------------------- | --------------------- |
| 0   | Установка, сборка, изучение проекта            | 1 неделя              |
| 1   | Автономная навигация по waypoint из файла      | 1.5 недели            |
| 2   | Детекция объектов YOLO (сравнение моделей)     | 1 неделя              |
| 3   | Навигация + YOLO (совместная работа)           | 1 неделя              |
|     | **Всего**                                      | **4.5 недели**        |

### Необходимые файлы для сдачи
...
lab2/
├── yolo_detector.yaml         # изменённый конфиг с разными моделями
...
- Файлы конфигурации должны быть уникальными (не копировать у других).
- Отчёты принимаются в формате PDF.
- Срок сдачи Работы №0 — 1 неделя, ЛР1 — 1.5 недели, ЛР2 — 1 неделя, ЛР3 — 1 неделя.
