...
help:
	...
	@echo ""
	@printf "${BOLD}YOLO:${NC}\n"
	@printf "  ${GREEN}${BOLD}make yolo${NC}                               Запуск YOLO детектора\n"
	@printf "  ${GREEN}${BOLD}make yolo-log LOG_INTERVAL=10${NC}           YOLO с логгированием в файл\n"
	...
	@printf "  ${GREEN}${BOLD}make experiment-run FILE=my_route${NC} Полный цикл эксперимента\n"
	@echo ""
