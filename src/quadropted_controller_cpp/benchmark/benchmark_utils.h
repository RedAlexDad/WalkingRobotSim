...
inline void print_joints(const std::string& label, const Eigen::VectorXd& joints) {
    std::cout << label << ": [";
...
inline void print_foot_locations(const std::string& label, const Eigen::MatrixXd& feet) {
    std::cout << label << ":\n";
...
inline Eigen::MatrixXd create_default_stance() {
