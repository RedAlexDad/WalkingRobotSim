...
class TrotStanceController {
  public:
    ...
    Eigen::Vector3d position_delta(int leg_index, const FootMatrix& state_foot, const Eigen::Vector3d& cmd_vel,
                                   double robot_height) const;
    Eigen::Vector3d next_foot_location(int leg_index, const FootMatrix& state_foot, const Eigen::Vector3d& cmd_vel,
                                       double robot_height) const;
