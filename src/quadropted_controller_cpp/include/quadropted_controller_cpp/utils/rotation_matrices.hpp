...
inline Eigen::Matrix3d rotx(double alpha) noexcept {
...
inline Eigen::Matrix3d roty(double beta) noexcept {
...
inline Eigen::Matrix3d rotz(double gamma) noexcept {
...
inline Eigen::Matrix3d rotxyz(double alpha, double beta, double gamma) noexcept {
