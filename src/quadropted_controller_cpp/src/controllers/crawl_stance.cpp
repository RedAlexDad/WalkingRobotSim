...
CrawlStanceController::CrawlStanceController(int phase_length, int stance_ticks,
    ...
    : phase_length_(phase_length), stance_ticks_(stance_ticks),
      ...
      z_error_constant_(z_error_constant), body_shift_y_(body_shift_y) {}

Eigen::Vector3d CrawlStanceController::next_foot_location(
