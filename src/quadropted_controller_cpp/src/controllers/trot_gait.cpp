...
TrotGaitController::TrotGaitController(double stance_time, double swing_time, double time_step, bool use_imu, Eigen::MatrixXd default_stance)
...
Eigen::MatrixXd TrotGaitController::step(int ticks, const Eigen::MatrixXd& current, const Eigen::Vector3d& cmd_vel, double robot_height) const {
