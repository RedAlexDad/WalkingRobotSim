...
TrotStanceController::TrotStanceController(int phase_length, int stance_ticks,
...
Eigen::Vector3d TrotStanceController::position_delta(
...
Eigen::Vector3d TrotStanceController::next_foot_location(
    int leg_index, const Eigen::MatrixXd& state_foot, const Eigen::Vector3d& cmd_vel,
    double robot_height) const
{
