...
Eigen::Vector3d TrotSwingController::raibert_touchdown_location(int leg_index,
                                                                 const Eigen::Vector3d& cmd_vel) const noexcept {
...
double TrotSwingController::swing_height(double swing_prop) const noexcept {
