...
GaitController::GaitController(double stance_time, double swing_time, double time_step,
...
const Eigen::MatrixXd& GaitController::default_stance() const { return default_stance_; }
int GaitController::stance_ticks() const { return stance_ticks_; }
int GaitController::swing_ticks() const { return swing_ticks_; }
int GaitController::phase_length() const { return phase_length_; }

const std::vector<int>& GaitController::phase_ticks() const { return phase_ticks_; }
