...
void PIDController::set_desired(double roll, double pitch) { desired_roll_pitch_ = {roll, pitch}; }

const std::array<double, 2>& PIDController::last_error() const { return last_error_; }
const std::array<double, 2>& PIDController::i_term() const { return i_term_; }
const std::array<double, 2>& PIDController::d_term() const { return d_term_; }
