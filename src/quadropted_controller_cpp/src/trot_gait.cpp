...
TrotGaitController::TrotGaitController(double stance_time, double swing_time, double time_step,
...
bool TrotGaitController::use_imu() const { return use_imu_; }
TrotSwingController& TrotGaitController::swing_controller() { return swing_; }
