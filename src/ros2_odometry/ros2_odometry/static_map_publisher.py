...
def load_map(yaml_file):
    ...
    image_path = os.path.join(
        get_package_share_directory("ros2_cartography"), "map", map_data["image"]
    )
...
def main(args=None):
    ...
    yaml_file = os.path.join(
        get_package_share_directory("ros2_cartography"), "map", "map.yaml"
    )
    # yaml_file = '/home/atharvag/ros2_ws/src/go1_sim/ros2_cartography/map/map.yaml'
