...
/**********************************************************************
Версия 0.1(250313)
Описание: Определение конкретного состояния пошагового тестирования в FSM
Функции
- calcTau: расчет крутящего момента для перемещения ног робота в заданное положение
***********************************************************************/
#ifndef STEPTEST_H
#define STEPTEST_H
