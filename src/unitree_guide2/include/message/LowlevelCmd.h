...
struct MotorCmd
{
    unsigned int mode;  //Режим работы двигателя
    float q;            //Укажите угловое положение
    float dq;           //Установите угол наклона и расстояние
    float tau;          //Крутящий момент прямой передачи
    float Kp;           //Жесткоть положения
    float Kd;           //Жесткость на скорости (демпфирование)
